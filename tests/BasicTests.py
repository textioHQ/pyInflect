...
class BasicTests(unittest.TestCase):
    ...
    def testGetInfections01(self):
        self.assertEqual(
            pyinflect.getAllInflections("awake", "V"),
        ...
        self.assertRaises(
            ValueError, pyinflect.getAllInflections, "awake", "VB"
        )  # pos_type doesn't have VB
    ...
    def testGetInflection03(self):
        self.assertEqual(
            pyinflect.getAllInflections("watch"),
            {
                "NN": ("watch",),
                "NNS": ("watches",),
                "VB": ("watch",),
        ...
        self.assertEqual(
            pyinflect.getAllInflections("watch", "V"),
            {
                "VB": ("watch",),
                "VBP": ("watch",),
                "VBD": ("watched",),
