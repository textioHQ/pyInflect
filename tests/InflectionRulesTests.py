...
class InflectionRulesTests(unittest.TestCase):
    ...
    def testRegularVerbs(self):
        ...
        test_cases.append(
            InflTestHelper("V", "distinguish", ("distinguishes", "distinguished", "distinguishing"))
        )
    ...
    def testGetInflection(self):
        ...
        self.assertEqual(
            pyinflect.getInflection("xxfocus", "NNS", inflect_oov=True), ("xxfocuses", "xxfoci")
        )
        self.assertEqual(
            pyinflect.getInflection("xxban", "VBG", inflect_oov=True), ("xxbaning", "xxbanning")
        )
        self.assertEqual(
